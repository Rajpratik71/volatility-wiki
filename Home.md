 ...
 * *Choose a release* - the most recent is [Volatility 2.4] (http://www.volatilityfoundation.org/#!23/c173h), released August 2014. Older versions are also available on the [Downloads](http://www.volatilityfoundation.org/#!releases/component_71401) page or respective release pages. If you want the cutting edge development build, use a git client and clone the master.
